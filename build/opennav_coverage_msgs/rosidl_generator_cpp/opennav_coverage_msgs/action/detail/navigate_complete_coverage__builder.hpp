...
class Init_NavigateCompleteCoverage_Result_error_msg
{
public:
  explicit Init_NavigateCompleteCoverage_Result_error_msg(::opennav_coverage_msgs::action::NavigateCompleteCoverage_Result & msg)
  : msg_(msg)
  {}
  ::opennav_coverage_msgs::action::NavigateCompleteCoverage_Result error_msg(::opennav_coverage_msgs::action::NavigateCompleteCoverage_Result::_error_msg_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NavigateCompleteCoverage_Result_error_msg error_code(::opennav_coverage_msgs::action::NavigateCompleteCoverage_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_NavigateCompleteCoverage_Result_error_msg(msg_);
  }
