...
static rosidl_typesupport_introspection_c__MessageMember opennav_coverage_msgs__action__NavigateCompleteCoverage_Result__rosidl_typesupport_introspection_c__NavigateCompleteCoverage_Result_message_member_array[2] = {
  {
    "error_code",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(opennav_coverage_msgs__action__NavigateCompleteCoverage_Result, error_msg),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
