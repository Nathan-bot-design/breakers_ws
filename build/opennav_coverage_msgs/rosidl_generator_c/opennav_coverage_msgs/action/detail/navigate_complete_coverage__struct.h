...
enum
{
  opennav_coverage_msgs__action__NavigateCompleteCoverage_Result__UNKNOWN = 800
};

/// Constant 'FAILED_TO_LOAD_BEHAVIOR_TREE'.
enum
{
  opennav_coverage_msgs__action__NavigateCompleteCoverage_Result__FAILED_TO_LOAD_BEHAVIOR_TREE = 801
};

/// Constant 'TF_ERROR'.
enum
{
  opennav_coverage_msgs__action__NavigateCompleteCoverage_Result__TF_ERROR = 802
};
