...
execute_process(
  COMMAND "/usr/bin/git" show-ref "4424a0fcc1c7fa640b5c87d26776d99150dacd10"
  WORKING_DIRECTORY "/home/nathan/ros2_ws/build/fields2cover/_deps/json-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "4424a0fcc1c7fa640b5c87d26776d99150dacd10")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4424a0fcc1c7fa640b5c87d26776d99150dacd10" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/4424a0fcc1c7fa640b5c87d26776d99150dacd10")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nathan/ros2_ws/build/fields2cover/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nathan/ros2_ws/build/fields2cover/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
