...
execute_process(
  COMMAND "/usr/bin/git" show-ref "5d01eb3695b07634a2b6642fd423740dea9b026c"
  WORKING_DIRECTORY "/home/nathan/ros2_ws/build/fields2cover/_deps/matplot-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "5d01eb3695b07634a2b6642fd423740dea9b026c")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5d01eb3695b07634a2b6642fd423740dea9b026c" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/5d01eb3695b07634a2b6642fd423740dea9b026c")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nathan/ros2_ws/build/fields2cover/_deps/matplot-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nathan/ros2_ws/build/fields2cover/_deps/matplot-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
